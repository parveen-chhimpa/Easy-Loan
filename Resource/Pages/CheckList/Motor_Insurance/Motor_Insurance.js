...
import { CheckList1, HealthLogo, MotoLogo, PropLogo } from '../../../Utils/Image'
import Filebase from '../../../Utils/Filebase'
import Share from 'react-native-share';

export default function Motor_Insurance(props) {
...
<SafeAreaView style={{ flex: 1, backgroundColor: 'rgb(244,245,249)' }}>
      <View style={{ flexDirection: 'row', marginTop: heightToDp('3') }}>
        ...
        <View style={{ justifyContent: 'center', marginStart: widthToDp('20') }}>
          <Text style={{ color: 'rgb(132,164,225)', fontSize: widthToDp('4.2'), fontWeight: 'bold' }}>Prop Writer CheckList</Text>
        </View>
      </View>
      <View style={{ alignItems: 'center', marginTop: heightToDp('4') }}>
        <Image source={PropLogo} style={{ height: heightToDp('10'), width: widthToDp('20') }} />
      </View>
